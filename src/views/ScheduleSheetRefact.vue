    ...
    const dummyData = ref([
      {
        ...
        status: '진행',
        manHours: 20,
        stakeholders: '홍길동(EP000)',
        __children: [
          {
            parentId: 1, title: 'Child Schedule', startDate: '2024-05-01', endDate: '2024-06-30', priority: 10,
            progress: 80, status: '진행', manHours: 20, stakeholders: '홍길동(EP000)', id: 2,
          },
        ]
      },
    ]);
